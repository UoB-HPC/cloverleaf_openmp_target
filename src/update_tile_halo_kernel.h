...
void update_tile_halo_l_kernel(
		...
		clover::Buffer2D<double> &left_density0,
		...
		clover::Buffer2D<double> &left_mass_flux_y,
...
void update_tile_halo_r_kernel(
		...
		clover::Buffer2D<double> &right_density0,
		...
		clover::Buffer2D<double> &right_mass_flux_y,
		const int fields[NUM_FIELDS],
		int depth);
...
void update_tile_halo_t_kernel(
		...
		clover::Buffer2D<double> &top_density0,
		...
		clover::Buffer2D<double> &top_xvel0,
		clover::Buffer2D<double> &top_yvel0,
		clover::Buffer2D<double> &top_xvel1,
		clover::Buffer2D<double> &top_yvel1,
		clover::Buffer2D<double> &top_vol_flux_x,
		clover::Buffer2D<double> &top_vol_flux_y,
		clover::Buffer2D<double> &top_mass_flux_x,
		clover::Buffer2D<double> &top_mass_flux_y,
		const int fields[NUM_FIELDS],
		int depth);
...
void update_tile_halo_b_kernel(
		...
		clover::Buffer2D<double> &bottom_mass_flux_y,
		const int fields[NUM_FIELDS],
		int depth);
